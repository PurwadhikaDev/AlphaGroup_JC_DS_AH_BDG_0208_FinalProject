...
def main():
    ...
    # ========================================================================
        ...
        This application uses machine learning to predict the likelihood of hotel booking cancellations
        and provides actionable recommendations to hotel management.
        ...
        ### 🎯 Business Goals
        1. Identify high-risk bookings early
        2. Reduce cancellation rate by 10-15%
        ...
        **Data Analysis:**
        ...
        2. Feature Engineering (43 new features created)
        3. Statistical Testing (Chi-square, T-tests)
        
        **Model Development:**
        1. Trained 4 algorithms (LR, DT, RF, XGBoost)
        2. 5-Fold Cross-Validation evaluation
        3. Selected top 2 models
        4. Hyperparameter tuning (GridSearchCV)
        5. **Final Decision: Use CV model (not tuned)**
        
        **Why Cross-Validation Model?**
        - ✅ CV provided robust baseline (F2: 83.1%)
        - ⚠️ Hyperparameter tuning showed overfitting
        ...
        **Top 5 Cancellation Predictors:**
        1. **Deposit Type** - Strongest predictor (non-refundable reduces cancellation ~60%)
        2. **Lead Time** - Bookings >180 days have higher risk
        3. **Previous Cancellation History** - Very strong predictor
        4. **Special Requests** - Shows commitment, reduces risk
        5. **Price (ADR)** - Higher prices correlate with more cancellations
        
        **Business Impact:**
        - Model catches 85%+ of cancellations
        - Potential revenue savings: $XXX,XXX
        - Expected cancellation reduction: 10-15%
        ...
        **Why These Metrics Matter:**
        - **Recall**: Catches 85% of cancellations (most important!)
        - **Precision**: 78% of predictions are correct
        - **F2-Score**: Balanced metric prioritizing recall
        
        ### 🎓 Academic Context
        - **Project Type**: Final Project - Data Science/Machine Learning
        - **Focus**: Predictive Analytics & Business Intelligence
        - **Approach**: End-to-end ML pipeline (EDA → Modeling → Deployment)
        
        ### 👨‍💻 Developer
        - **Name**: Your Name
        - **Institution**: Your University
        - **Program**: Data Science / Computer Science
        - **Year**: 2024
        ...
        ### 📚 References
        1. Hotel Booking Demand Dataset - Kaggle
        2. Antonio, Almeida, & Nunes (2019) - Hotel booking demand datasets
        ...
        This model is developed for **educational and research purposes**. While the model
        achieves strong performance on historical data, predictions should be used as
        **decision support tools**, not as the sole basis for business decisions.
        ...
        **Made with ❤️ for hospitality industry optimization**
        """)
